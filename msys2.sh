...
cygrunsrv -I msys2_sshd -d "XKZ sshd" -p \
...
# install serviced
#!/bin/sh
cygrunsrv -R serviced || true
cygrunsrv -I serviced -d "XKZ serviced" -p \
          /usr/bin/serviced.exe -a "srv /home/serviced/conf/serviced.json" -c /home/serviced/ --stdout /var/log/serviced.log --stderr=/var/log/serviced.log

cygrunsrv -R rsc || true
cygrunsrv -I rsc -d "XKZ rsc" -p \
          /usr/bin/rsc.exe -a "-f /home/rsc/conf/rsc-srv.json" -c /home/rsc/ --stdout /var/log/rsc.log --stderr=/var/log/rsc.log